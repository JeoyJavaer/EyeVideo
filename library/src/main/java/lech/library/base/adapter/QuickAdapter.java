...
public abstract class QuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (getOnItemClickListener() != null && baseViewHolder != null) {
                    ...
                    getOnItemClickListener().onItemClick(QuickAdapter.this, v, baseViewHolder.getLayoutPosition() - getHeaderLayoutCount());
                }
        ...
        view.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (getOnItemLongClickListener() != null && baseViewHolder != null) {
                    return getOnItemLongClickListener().onItemLongClick(QuickAdapter.this, v, baseViewHolder.getLayoutPosition() - getHeaderLayoutCount());
                }
                return false;
    ...
    /**
     * When the current adapter is empty, the QuickAdapter can display a special view
