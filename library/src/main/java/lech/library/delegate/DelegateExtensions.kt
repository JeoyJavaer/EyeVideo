...
class Preference<T>(val context: Context,val name: String,val default: T){
    ...
    val prefs:SharedPreferences by lazy { context.getSharedPreferences("config", Context.MODE_PRIVATE) }
    ...
    private fun  findPreference(name: String, default: T): T = with(prefs) {
        val res: Any = when (default) {
            ...
            else ->throw IllegalArgumentException("This type  can not put into sp")
